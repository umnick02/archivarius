...
названиям и переходы по связям позволяют находить содержание без знания ключей.
...
применимости. Новое требование, для которого ещё нет реализации или задачи,
