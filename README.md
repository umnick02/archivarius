...
Изменение любого определения пока консервативно пересматривает основания всего
проекта. Показанный итог относится к загруженному снимку; после изменений нужна
