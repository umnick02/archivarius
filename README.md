...
геометрия остаётся неподвижной. Кнопка **«Проект»** открывает поиск и просмотр записей.
...
Во входе v4 нет `implemented`. Итог «полностью реализовано — да / нет» вычисляется
...
к загруженному снимку; после изменений нужна повторная загрузка.
