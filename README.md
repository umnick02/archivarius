...
| Architecture map | Lays out components and interactions with semantic zoom. Wheel, pinch and zoom controls move directly between framed hierarchy levels and stop at readable leaves or the overview. Card facts appear together; expanded containers show their name and children. Edge labels name their interaction type or aggregate count. |
