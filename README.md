...
| Architecture map | Draws components and interactions on the full canvas with semantic zoom. Wheel, pinch and keyboard navigate framed hierarchy levels; cards and edges carry their own meanings. There are no floating camera controls, minimap, breadcrumbs or duplicate connection lists. Component details and connections open in the inspector. |
