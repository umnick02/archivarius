...
| Architecture map | Lays out components and interactions with semantic zoom. A card has a compact view with its identity and an open-parts action, and a readable view that reveals kind, zone, confirmation and counted attention or work together. Expanded containers show their name and children. Edge labels name their interaction type or aggregate count. |
