...
| Architecture map | Lays out components and interactions with semantic zoom. Component cards show confirmed criteria, the highest-priority evidence issue and assigned work from the same project analysis used by the inspector. |
