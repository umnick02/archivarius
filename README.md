...
flowchart LR
    ...
    subgraph c-render["Map rendering"]
        ...
        c-inspector["Project workspace and inspector"]:::presentation
    end
...
| Project workspace and inspector | Shows requirements, work, checks and documents in a full workspace, with component details beside the map. |
